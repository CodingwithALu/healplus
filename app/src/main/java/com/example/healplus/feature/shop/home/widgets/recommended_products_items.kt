...
@Composable
fun RecommendedProductItem(item: ProductsModel, navController: NavController) {
    ...
    val formattedPrice = NumberFormat.getCurrencyInstance(Locale("vi", "VN")).format(item.unitNames.firstOrNull()?.price?: 0)
    Card (
        modifier = Modifier
            .width(200.dp)
            .wrapContentHeight()
